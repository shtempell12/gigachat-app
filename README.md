...
> Ссылка на развёрнутое приложение появится после деплоя на Vercel.

## Переменные окружения

| Переменная | Описание | Обязательна |
|---|---|---|
| `VITE_OPENAI_API_KEY` | API-ключ OpenAI | Да |

Создайте файл `.env` на основе `.env.example` и вставьте свой ключ.
